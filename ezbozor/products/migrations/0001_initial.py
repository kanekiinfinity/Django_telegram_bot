    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_name', models.CharField(max_length=50, null=True, verbose_name='Mahsulot nomi')),
                ('photo', models.ImageField(max_length=200, upload_to='', verbose_name='Rasm file_id')),
                ('price', models.DecimalField(decimal_places=2, max_digits=10, null=True, verbose_name='Narx')),
                ('description', models.TextField(max_length=500, verbose_name='Mahsulot haqida')),
